...
//  EmotiLink
//
//  Created by Star on 7/19/16.
//  Copyright © 2016 Stark. All rights reserved.
//  created by Zeenath
//  created on 19/7/2016
//  created for custom calendar funcationality
...
- (void)setDate:(NSDate *)date {
    _date = date;
    if (date) {
        NSDateComponents *comps = [self.calendar components:NSCalendarUnitDay|NSCalendarUnitDay fromDate:date];
...
- (void)_init:(CKCalendarStartDay)firstDay {
   ...
   /// highlight.layer.cornerRadius = 6.0f;
    ...
    titleLabel.backgroundColor = [UIColor colorWithRed:228.0/225.0 green:109.0/225.0 blue:175.0/225.0 alpha:1.0];
    ...
    [prevButton setImage:[UIImage imageNamed:@"left-arrow-white-14x17.png"] forState:UIControlStateNormal];
    ...
    [nextButton setImage:[UIImage imageNamed:@"right-arrow-white-14x17.png"] forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    while ([date laterDate:endDate] != date) {
        ...
        if ([self _dateIsToday:dateButton.date]) {
            ...
            item.backgroundColor = [UIColor colorWithRed:228/255.0 green:109.0/255.0 blue:175.0/255.0 alpha:1.0];
        ...
        if (self.selectedDate && [self date:self.selectedDate isSameDayAsDate:date]) {
            ...
            //clicked1
            dateButton.backgroundColor = [UIColor colorWithRed:228/255.0 green:109.0/255.0 blue:175.0/255.0 alpha:1.0];
        }
      /*  else if([_clickedButton isEqualToString:@"clicked" ])
        {
             dateButton.backgroundColor = [UIColor colorWithRed:228/255.0 green:109.0/255.0 blue:175.0/255.0 alpha:1.0];
        }*/
        else
...
- (void)_setDefaultStyle {
    self.backgroundColor = [UIColor colorWithRed:239/255.0 green:239.0/255.0 blue:239.0/255.0 alpha:1.0];
    
    [self setTitleColor:[UIColor whiteColor]];
    [self setTitleFont:[UIFont fontWithName:@"CenturyGothic.ttf" size:17.0f]];
    
    [self setDayOfWeekFont:[UIFont fontWithName:@"CenturyGothic.ttf" size:12.0f]];
    ...
    [self setDateFont:[UIFont fontWithName:@"CenturyGothic.ttf" size:16.0f]];
...
- (void)setMonthButtonColor:(UIColor *)color {
    [self.prevButton setImage:[CKCalendarView _imageNamed:@"left-arrow-white-14x17.png" withColor:color] forState:UIControlStateNormal];
    [self.nextButton setImage:[CKCalendarView _imageNamed:@"right-arrow-white-14x17.png" withColor:color] forState:UIControlStateNormal];
}
